...
PARAM$rpart$cp         <-  -0.358681600527232
PARAM$rpart$minsplit   <- 769.761659354105
PARAM$rpart$minbucket  <- 305.314565698041
PARAM$rpart$mixdepth   <-   8

PARAM$prob_corte       <-   0.0419420708009139
