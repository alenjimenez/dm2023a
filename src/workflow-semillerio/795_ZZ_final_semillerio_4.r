...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_1_202109_no_manual"
PARAM$exp_input  <- "HT7510_1_202109_no_manual"
...
PARAM$semillerio  <- 35   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 123457   # se utiliza para generar el vector de  PARAM$semillerio  semillas
